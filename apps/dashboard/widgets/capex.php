...
openDB();
	...
	echo "				theme: 'dark2',\n"; 
	echo "				axisY: { labelFontSize: 12, labelFontFamily: 'Arial, Helvetica, Monospaced, sans-serif', labelFontColor: '#AAAAAA', gridThickness: 1, gridColor: '#444444', lineColor: '#2D2D2D', lineThickness: 10 },\n";
	...
	echo "		<div class='columns_basic-title'><h4>" . translate("NonPresentedProposals") . " - " . translate("Brazil") . "</h4><small>" . translate("ByCapex") . "</small></div>\n"; 
