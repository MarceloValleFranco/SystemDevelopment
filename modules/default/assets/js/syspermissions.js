...
// SYSPERMISSIONS.JS 1.0 (2018/11/30)
...
$(function () {
	...
	$(".user-group-id").select2({ minimumResultsForSearch: Infinity }).on("select2:open", function () { $('.select2-results__options').niceScroll({
		cursorcolor:"#ccc", 
		cursorwidth:"8px",
		cursorborder: "0",
		railpadding: { top: 2, right: 2, left: 0, bottom: 2 }});
	...
	$(".user-group-id").change(function () {
		window.location.href=('?g=' + this.value);
	});	
